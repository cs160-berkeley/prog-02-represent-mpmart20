...
public class repSlides extends WearableActivity {
    View myView;
    View myView2;
    View myView3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reps_main);
        addListenerOnView();
    }
    ...
    public void addListenerOnView() {
        ...
        myView = findViewById(R.id.first);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch(action) {
                    ...
                    case (MotionEvent.ACTION_UP) :
                        ...
                        if (x1 < x2)
                        {
                            RelativeLayout frame3 = (RelativeLayout) findViewById(R.id.end);
                            frame3.setVisibility(View.INVISIBLE);
                            RelativeLayout frame4 = (RelativeLayout) findViewById(R.id.mid);
                            frame4.setVisibility(View.VISIBLE);
                        }
                        ...
                        if (x1 > x2)
                        {
                            RelativeLayout frame = (RelativeLayout) findViewById(R.id.end);
                            frame.setVisibility(View.INVISIBLE);
                            RelativeLayout frame2 = (RelativeLayout) findViewById(R.id.first);
                            frame2.setVisibility(View.VISIBLE);
                        }
                        ...
                        //if Down to UP sweep event on screen //add going to house
                        if (y1 > y2){
                            Intent intent = new Intent(context, housew.class);
                            startActivity(intent);
